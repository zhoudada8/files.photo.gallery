...
class U {
  ...
  public static function assetspath(){
    ...
    return self::$assetspath = Config::get('assets') ? rtrim(Config::get('assets'), '/') . '/' : '_files/assets/';//修改本地化位置1
  }
...
if(U::get('action')){
  ...
  // attempt to update Files Gallery index.php to latest version via remote repository jsdelivr.com
    ...
    $get = @file_get_contents('_files/assets/files.photo.gallery@' . $version . '/index.php');//修改本地化位置2
